...
public class EKE2B extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
      ...
      //getWindow().requestFeature(Window.FEATURE_NO_TITLE);
        ...
        setContentView(R.layout.activity_eke2_b);
        
        WebView webView = (WebView) findViewById(R.id.webviewEke2b);
        ...
        webView.setWebChromeClient(new WebChromeClient() {
            public void onProgressChanged(WebView view, int progress)
            {
                ...
                if(progress == 100)
                    activity.setTitle(R.string.title_activity_eke2_b);
            }
        });
   ...
   /* @Override
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.activity_eke2_b, menu);
        return true;
    }*/
}
