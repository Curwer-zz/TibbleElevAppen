...
public class EKE2A extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
      ...
      //getWindow().requestFeature(Window.FEATURE_NO_TITLE);
        ...
        setContentView(R.layout.activity_eke2);
        
        WebView webView = (WebView) findViewById(R.id.webviewEke2a);
        ...
        webView.setWebChromeClient(new WebChromeClient() {
            public void onProgressChanged(WebView view, int progress)
            {
                ...
                if(progress == 100)
                    activity.setTitle(R.string.title_activity_eke2);
            }
        });
   ...
   /* @Override
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.activity_eke2, menu);
        return true;
    }*/
}
